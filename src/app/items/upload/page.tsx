...
const Upload: NextPage = () => {
  return (
    <div className="px-4 py-16">
      ...
      <div className="my-5">
        ...
        <div className="relative flex items-center rounded-md shadow-sm">
          ...
          <input
            ...
            type="text"
            placeholder="0.00"
            className="w-full appearance-none rounded-md rounded-l-none border border-gray-300 px-3 py-2 pl-7 placeholder-gray-400 shadow-sm
      ...
      <div>
        <label htmlFor="price text-sm font-medium mb-1">Description</label>
        <textarea
          rows={4}
